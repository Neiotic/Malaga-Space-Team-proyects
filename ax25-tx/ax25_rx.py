...
class ax25_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "AX.25 BFSK Reciever", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AX.25 BFSK Reciever")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ax25_rx")
        ...
        self.connect((self.satellites_nrzi_decode_0, 0), (self.blocks_file_sink_1, 0))
